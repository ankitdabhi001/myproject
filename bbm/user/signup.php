        ...
        <form action="signup.php" method="POST">
            ...
            <div class="form-group">
			 ...
			 <div class="form-group">
                ...
                <input type="radio" id="gen1" name="gender" value="Male"required><label id="ma" for="gender">Male</label>
				<input type="radio" id="gen" name="gender" value="female"required><label id="ma1" for="gender">Female</label>
