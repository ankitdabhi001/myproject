<?php
$boat_services = [
    ["route" => "Assi Ghat — Shivala Ghat", "price" => 80, "image" => "/myproject/bbm/user/css/images/boat1.jpg"],
    ["route" => "Assi Ghat — Ramnagar", "price" => 100, "image" => "boat2.jpg"],
...
<div class="container">
    <?php foreach ($boat_services as $service): ?>
        <div class="card">
            <img src="<?php $service['image']; ?>" alt="Boat">
            <div class="details">
                <h3><?= $service['route']; ?></h3>
                <div class="price"><?php $service['price']; ?></div>
                <button>Book</button>
            </div>
        </div>
    <?php endforeach; ?>
